...
def draw_clipped_sphere(radius, sides, vertical_scale, horizontal_scale):
...
def draw_filled_circles(radius, sides, vertical_scale, horizontal_scale):
    for i in range(-sides // 2, sides // 2):
        lat = math.pi * (i / sides)
...
def draw_figure(entry):
    ...
    while True:
        ...
        draw_clipped_sphere(1, 20, vertical_scale * scale_factor, scale_factor)
        draw_filled_circles(1, 20, vertical_scale * scale_factor, scale_factor)
